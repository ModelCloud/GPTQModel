...
#include "marlin_cuda_kernel_24.cuh"
#include "marlin_repack_24.cuh"
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("mul_2_4", &mul_2_4, "Marlin 2:4 FP16xINT4 matmul.");
  m.def("gptq_repack_2_4", &gptq_repack_2_4, "Repack GPTQ checkpoints for Marlin.");
}
