# Full W4 public GPTQ staged lifecycle validation

Status: complete. All 16 layers trained; all 32 held-out documents reload exactly.

All 482 checkpoint tensors and all 32 held-out logit tensors equal the earlier dedicated Lion run; see checkpoint-parity.json. This establishes public dispatch parity, not a quality gain.

Quantization stdout/stderr: /root/polly-work/qvq-gsq/artifacts/gsq-staged/logs/full-model-w4-nm128-signed-public-v1.log; SHA256 592423b1ab025040ae82f454b767503c11159e42f4e79b015dae928e52a69bfe. ZML not used.

```json
{
  "state": "complete",
  "arm": "staged",
  "run_id": "full-model-w4-nm128-signed-public-v1",
  "lifecycle": "public",
  ...
  "argv": [
    ...
    "--output",
    "artifacts/gsq-staged/full-model-w4-nm128-signed-public-v1",
    "--arm",
    "staged",
    "--bits",
    "4",
  ...
  "started_utc": "2026-09-09T13:30:18.942130+00:00",
  ...
  "source_hashes": {
    "/root/polly-work/qvq-gsq/scripts/validate_gsq_full_llama.py": "a099c05e754ea1b939bb04a8e3dcdf110a8eb58ef6e681b4c1bdf925f5d1e0ea",
  ...
  "finished_utc": "2026-09-09T13:45:32.599051+00:00",
  "model_hashes": {
    "config.json": "4540b1e2842ee46e548168b4361664e748ee984991b4b9250062e3866924260c",
    "generation_config.json": "7cfdf52ffe0e0c1c95ab0dc42aafc4117ba4c0d9804905cebb08eee36c6b7144",
    "quantize_config.json": "b291b3703f8a225bf2a0b5d82f17553e19bf4bbf0f83034fef535674dc0cb2f8",
