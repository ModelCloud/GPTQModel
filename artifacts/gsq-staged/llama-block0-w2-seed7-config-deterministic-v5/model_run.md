...
```json
{
  ...
  "log": "artifacts/gsq-staged/logs/llama-block0-w2-seed7-config-deterministic-v5.log",
  "log_sha256": "68d8551decb2983242df552df627549ddf67beaa53f0d01df8e506055cadf1d6"
}
```
...
```json
{
  ...
  "started_utc": "2026-09-09T09:59:05.056982+00:00",
  "argv": [
    "scripts/validate_gsq_staged_llama.py",
    "--inputs",
    "artifacts/gsq-scalar/gptq-w4-seed7-v2",
    "--output",
    "artifacts/gsq-staged/llama-block0-w2-seed7-config-deterministic-v5",
    "--bits",
    "2",
    "--epochs",
    "10",
  ...
  "run_id": "llama-block0-w2-seed7-config-deterministic-v5",
  ...
  "finished_utc": "2026-09-09T09:59:47.348893+00:00"
}
```
