...
"""Configuration for staged scalar GSQ block training."""
...
class GSQTrainingConfig:
    """Opt-in dense Llama staged training with paper-style optimizer settings."""
    ...
    def __post_init__(self):
        ...
        if self.initializer not in ('gptq', 'rtn', 'awq'):
            raise ValueError('GSQTrainingConfig: initializer must be gptq, rtn or awq')
