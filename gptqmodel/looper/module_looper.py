...
from typing import Dict, List, NamedTuple, Optional, TYPE_CHECKING, Union, Tuple
...
class ModuleLooper():
        ...
        *,
        ...
        for batch_idx in range(total_batches):
            ...
            try:
                ...
                override_ctx = (
                    self.MoERoutingOverrideContext(module, self.moe_routing_override)
                    if self.moe_routing_override
                    else nullcontext()
                )
                with override_ctx:
    ...
    def _run_forward_batches_parallel(
        ...
        *,
        ...
        # Clone modules FIRST, then apply MoE routing overrides to all replicas
        try:
        ...
        # Apply MoE routing overrides to all replicas (not just the original module)
        moe_contexts = []
        try:
            ...
            # Clean up MoE routing overrides from all replicas
