...
class BACKEND(str, Enum):
    ...
    GPTQ_HF_KERNEL = "gptq_hf_kernel"  # original HF CPU GPTQ kernel folded into GPT-QModel
    ...
    AWQ_HF_KERNEL = "awq_hf_kernel"  # original HF CPU AWQ kernel folded into GPT-QModel
    AWQ_TORCH = "awq_torch"
