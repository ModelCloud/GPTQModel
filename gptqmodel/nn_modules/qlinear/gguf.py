...
_GGUF_TYPE_INFO = {
    ...
    "PQ2_0": {"bits": 2, "block_size": 128, "type_size": 34},
...
PRISM_Q2_0_NAME = "PQ2_0"
PRISM_Q2_0_VALUE = 142
...
def _gguf_quantize_pq2_0(blocks: np.ndarray) -> np.ndarray:
...
def _fallback_gguf_quantize(weight: np.ndarray, tensor_qtype: str) -> np.ndarray:
    ...
    if tensor_qtype in _GGUF_SIGN_ONLY_TYPE_INFO:
        ...
        quantized_blocks = _gguf_quantize_pq2_0(blocks)
