...
class LongCatFlashQModel(BaseQModel):
    ...
    module_tree = [
        ...
        "#",
        {
            ...
            "self_attn": {
                "0": ("q_a_proj:0:q", "q_b_proj:0:q", "kv_a_proj_with_mqa:0:k:v", "kv_b_proj:0:k:v", "o_proj:1"),
                "1": ("q_a_proj:0:q", "q_b_proj:0:q", "kv_a_proj_with_mqa:0:k:v", "kv_b_proj:0:k:v", "o_proj:1")
            },
