...
_EXTENSION_SPECS = (
    ...
    _ExtensionSpec(
        name="qvq_cpu",
        aliases=("qvq_gemv_cpu",),
        resolve=lambda: _resolve_extension_attr("gptqmodel.utils.qvq_cpu", "_QVQ_CPU_TORCH_OPS_EXTENSION"),
        supported=lambda: _resolve_attr("gptqmodel.utils.qvq_cpu", "qvq_cpu_supported")(),
        unsupported_error=lambda: _resolve_attr("gptqmodel.utils.qvq_cpu", "qvq_cpu_error")(),
    ),
    _ExtensionSpec(
        name="floatx_cpu",
    ...
    _ExtensionSpec(
        name="amplin",
        aliases=("gptq_amplin",),
        resolve=lambda: _resolve_extension_attr("gptqmodel.utils.amplin", "_AMPLIN_TORCH_OPS_EXTENSION"),
        supported=lambda: _resolve_attr("gptqmodel.utils.amplin", "amplin_supported")(),
    ...
    _ExtensionSpec(
        ...
        aliases=(),
        resolve=lambda: _resolve_extension_attr(
            "gptqmodel.utils.cannoe", "_CANNOE_V3_TORCH_OPS_EXTENSION"
        ),
        supported=lambda: _resolve_attr("gptqmodel.utils.cannoe", "_cannoe_v3_supported")(),
        unsupported_error=lambda: _resolve_attr(
            "gptqmodel.utils.cannoe", "cannoe_v3_environment_error"
        )(),
    ),
    _ExtensionSpec(
        name="cannoe_ascendc",
        aliases=(),
        resolve=lambda: _resolve_extension_attr(
            "gptqmodel.utils.cannoe", "_CANNOE_ASCENDC_TORCH_OPS_EXTENSION"
        ),
        supported=lambda: _resolve_attr("gptqmodel.utils.cannoe", "_cannoe_ascendc_supported")(),
        unsupported_error=lambda: _resolve_attr(
            "gptqmodel.utils.cannoe", "cannoe_ascendc_environment_error"
        )(),
    ),
)
