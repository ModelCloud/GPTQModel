...
| QQQ | Grouped/channelwise candidate decoder, paired activation moments and fixed-scale code optimizer implemented with 26 CPU contract checks; quantizer/collector/packer binding and real-model validation pending ([audit](../../research/qqq.md#gsq-adapter-audit-2026-09-09)) |
