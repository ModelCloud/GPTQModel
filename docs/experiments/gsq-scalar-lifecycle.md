...
| FP8 | Local fixed-scale E4M3/E5M2 payload adapter, optional config and weight-only post-pack binding implemented; CPU forced-change save/reload/inference checks pass. GPU, real-model calibration/quality, scale learning and full-model exports pending; see [FP8 validation](gsq-fp8.md) |
