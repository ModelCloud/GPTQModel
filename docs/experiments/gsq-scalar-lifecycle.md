...
| QQQ | Grouped/channelwise candidate decoder and paired activation-moment helper implemented with 22 CPU contract checks; optimizer/collector binding and real-model validation pending ([audit](../../research/qqq.md#gsq-adapter-audit-2026-09-09)) |
