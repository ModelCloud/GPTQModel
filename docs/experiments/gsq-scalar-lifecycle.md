...
| QQQ | Grouped/channelwise candidate decoder implemented with 18 CPU contract checks; optimizer binding, paired quantized-activation statistics and real-model validation pending ([audit](../../research/qqq.md#gsq-adapter-audit-2026-09-09)) |
