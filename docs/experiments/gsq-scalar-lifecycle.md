...
| QQQ | Fixed-scale GSQ bound to quantizer, paired-moment collector and verified producer packing; 36 CPU checks pass; real-model, native GPU and broader lifecycle validation pending ([audit](../../research/qqq.md#gsq-adapter-audit-2026-09-09)) |
