...
Median fused/window full-layer ratios were:
...
Split-K=2 does not beat the corresponding split-1 BM64/BN64 result and adds
reduction work. It does not advance. Maximum teacher error was 0.012510 and
