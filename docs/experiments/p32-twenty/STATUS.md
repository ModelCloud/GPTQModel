...
|4|Warp-specialized pipeline|BM16 and BM32 direct decode/MMA baselines cover 12 projections and 12 row counts with 288/288 local passes; median fused/window remains below 1.0x except a BM32 tie at large M. Producer/consumer overlap implementation remains.|
