...
|---:|---|---|
|1|Decoder decomposition|Real-layer timing and matched CUDA profiler-hook coverage now cover 12 projections and all nine row counts; external instruction-class counters, occupancy/memory traffic, and decoder/GEMM overlap remain.|
