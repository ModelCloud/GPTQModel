...
|4|Warp-specialized pipeline|BM16/BN32 direct decode/MMA baseline covers 12 projections and 12 row counts with 144/144 local passes, but median fused/window is below 1.0x; producer/consumer overlap implementation remains.|
