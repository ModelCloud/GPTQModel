...
|4|Warp-specialized pipeline|Split-1, split-2, and split-4 direct decode/MMA tile baselines now cover 12 projections and 12 row counts with 1,584/1,584 local passes; split-K variants remain below split-1 performance and below the 2x target. Producer/consumer overlap implementation remains.|
