...
|4|Warp-specialized pipeline|Split-1 and split-2 direct decode/MMA tile baselines now cover 12 projections and 12 row counts with 1,296/1,296 local passes; split-K=2 remains below split-1 performance and below the 2x target. Producer/consumer overlap implementation remains.|
