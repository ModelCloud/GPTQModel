...
| 2026-05-22 | `d73eebb0` | Group32 3-bit wide batch tile | Batch GEMM 3-bit group32 now also uses the 8-row wide batch tile for batch8 wide-feature shapes, reducing grid z-slices and split-K atomics from `2048 -> 1024` CTAs. Nsight improved `189.856 us -> 184.640 us`, instructions dropped `92.39M -> 80.16M`, registers/thread rose `40 -> 47`, and host median improved `0.2360 ms -> 0.2244 ms`. |
