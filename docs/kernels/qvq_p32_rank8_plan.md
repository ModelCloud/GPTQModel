...
| 4 | Existing Hopper WGMMA + optional rank8; H100/H200 BM/BN/warp-group/stage candidates | Existing WGMMA retained; single-projection policies expose BM32/64/128 × BN64/128 with BK256/stages2, while grouped policies expose validated BM32/64/128 × BN64; H200 off/on sweep; selected BN controls the rank8 projection/epilogue warp width and graph-warm identity | BN32 and additional stage/warp candidates, generic multi-segment grouped BN128, integrate rank8 into consumer pipeline, both-device sweep |
