...
| 10 | Combined scorecard, teacher/tail/logit/PPL/ARC/GSM8K, prefill/decode, TP, VRAM/BPW/overhead | Preparation-time rank candidate sweep (2/4/6/8/12) now records output-aware solver and serialized-FP16 scores; local tests and synthetic H200 full-operator benchmark plus Nsight artifacts | Runtime dynamic-rank kernels, real disjoint model scorecard; H100/H200, M128–8192, batches1–64, TP1/2/4/8; statistical quality gates |
