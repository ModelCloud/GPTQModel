...
The ABI and kernel versions are exported separately. Consumers must include
both values in transient autotune keys and reject incompatible libraries during
initialization.
