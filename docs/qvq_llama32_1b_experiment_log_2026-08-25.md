...
| Q07 higher-rate sweep attempt 4 | telemetry-capable commit `329cc0a5`; exact-auto pruning; all Q07 controls unchanged; W2.5 output `/root/qvq-results/llama32-1b-v2b2p32-yaqa322k-w25-reg010-pruneauto-main-329cc0a5` on physical GPU UUID `GPU-737e2423-874a-23a4-1126-dfbe3e77c294`; W3 output `/root/qvq-results/llama32-1b-v2b2p32-yaqa322k-w30-reg010-pruneauto-main-329cc0a5` on `GPU-724ea08e-67c3-c0ce-29bb-e6c48e7dde28` | running concurrently; each arm independently confirmed 182 YAQA rows / 302,193 tokens and 128 ordinary lifecycle rows / 49,725 tokens; quantization only, no evaluation authorized |
