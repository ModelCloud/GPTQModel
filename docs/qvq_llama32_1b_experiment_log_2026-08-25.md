...
uniform `.20`. The pre-telemetry higher-rate arms were stopped before checkpoint publication; their telemetry-capable
restarts are pending. Nothing in this ledger claims the target has been reached, and no proxy-only
