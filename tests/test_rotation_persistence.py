...
def test_setup_rotation_online_had_non_pow2_had_K_non_zero():
    model = _DummyModel(11008, 4096)
    _setup_rotation_online_had(model, "hadamard")
...
def test_rotation_loaded_from_quantized_down_proj_has_online_state():
    ...
    # Online flags are attached by _setup_rotation_online_had at load time; do not
    # import the full model here, just confirm the config round-trips.
