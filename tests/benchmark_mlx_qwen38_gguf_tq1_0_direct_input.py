...
"""Benchmark main's FP32-temporary TQ1_0 path against direct MLX input."""
...
def _main_pack(weight):
    ...
    parallel = blocks >= 65536
    kernel = _gguf_tq1_0_parallel_kernel() if parallel else _gguf_tq1_0_kernel()
    launch = (
