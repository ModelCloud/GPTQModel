...
class TestOvis1_6_Llama(ModelTest):
    ...
    def test_ovis_1_6(self):
        model, tokenizer = self.quantModel(self.NATIVE_MODEL_ID, trust_remote_code=self.TRUST_REMOTE_CODE, torch_dtype=self.TORCH_DTYPE, multimodal_max_length=8192,)
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            model = GPTQModel.load(tmp_dir, trust_remote_code=True)
