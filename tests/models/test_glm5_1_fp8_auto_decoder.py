...
class TestGlm5_1Fp8AutoDecoder(ModelTest):
    """Verify FP8 auto-decoder mode selection on one visible GPU."""

    NATIVE_MODEL_ID = "/monster/data/model/GLM-5.1-FP8"
    ...
    def test_glm5_1_fp8_auto_decoder_selects_forward_role_by_gpu_capability(self) -> None:
        if not torch.cuda.is_available():
            self.skipTest("CUDA is required for the GLM-5.1 FP8 auto-decoder test.")
        ...
        try:
            ...
            self.assertTrue(events, "Expected layer-0 auto-decoder events for GLM-5.1-FP8.")
