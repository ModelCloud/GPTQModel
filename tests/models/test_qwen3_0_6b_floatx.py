...
decode of the same native source.  Since a single GSM8K answer changes this
eight-row smoke score by 12.5 points, the floor requires at least one answer.
"""
...
class _Qwen3_0_6BFloatxBase:
    ...
    def check_results(self, task_results):
        ...
        regression_floor = max(expected_value * 0.5, 0.125)
...
class TestQwen3_0_6BFP8(_Qwen3_0_6BFloatxBase, ModelTest):
    ...
    # Dense BF16 decode of this exact source, Evalution 0.0.17, first 8 rows,
    # suite batch_size=8, eager attention, CUDA:0.
...
class TestQwen3_0_6BNVFP4(_Qwen3_0_6BFloatxBase, ModelTest):
    ...
    # Same matched dense-source reference configuration as the FP8 case.
    DENSE_GSM8K_PLATINUM_ACC = 0.125
