...
## News
* 01/19/2025 [1.7.1](https://github.com/ModelCloud/GPTQModel/releases/tag/v1.7.1): Effective BPW (bits per weight) will now be logged during `load()`. Reduce memory usage in MLX conversion and fix Marlin kernel auto-select not checking CUDA compute version. 
