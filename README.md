...
* 08/19/2026 7.4.0 `main`: ✨ Added `mage_vl`, `muse_glimmer`, `olmo3`, `smollm3` and `deepseek_v32` model support
...
| Muse Glimmer                  | ✅ | SmolLM3                         | ✅ | LocateAnything | ✅ | HunyuanOCR | ✅ | Unlimited-OCR | ✅ |
