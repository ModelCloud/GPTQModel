...
## News
* 01/03/2025 [1.5.2](https://github.com/ModelCloud/GPTQModel/releases/tag/v1.5.2): AMD ROCm (6.2+) support added and validated for 7900XT+ GPU. Decrease memory usage (vram) during quantization.
