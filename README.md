...
## News
* 12/15/2024 [1.4.1](https://github.com/ModelCloud/GPTQModel/releases/tag/v1.4.2）MacOS `gpu` (Metal) and `cpu` support added/validated. Cohere 2 model support added. 
