...
## News
* 03/12/2025 [2.1.0](https://github.com/ModelCloud/GPTQModel/releases/tag/v2.1.0): ✨ New `QQQ` quantization method and inference support! New AMD `Instella` model support. New `GSM8K Platinum` and `MMLU-Pro` benchmarking suppport. ROCm auto `setup.py` compat fixes. `Optimum` and `Peft` compat fixes.
