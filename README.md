...
## News
* 01/19/2025 [1.7.1 Patch](https://github.com/ModelCloud/GPTQModel/releases/tag/v1.7.1): Reduce memory usage in MLX conversion and fix Marlin kernel auto-select not checking CUDA compute version. 
