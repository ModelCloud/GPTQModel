...
## News
* 10/28/2024 🚀 [v1.1.0](https://github.com/ModelCloud/GPTQModel/releases/tag/v1.0.9) (PENDING) IBM Granite model support. Full auto-buildless wheel install from pypi. 
