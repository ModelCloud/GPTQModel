...
## News
* 02/10/2025 [1.8.2-dev]: ⚡ Optimized `lm_head` quant time, memory usage and `error_loss`. Optimized `DeekSeek v3/R1` model quant vram requirement. Fixed `optimum` compat regresion in `v1.8.1`.
