...
## News
* 11/27/2024 [1.3.1-dev] Olmo2 model support. Intel XPU acceleration via IPEX. Transformer compat due to direct sharding hard-deprecation within latest transformers. 
