...
### PIP 
```
# Include any specific modules needed using brackets. Example: pip install gptqmodel[sglang,vllm,bitblas,lm_eval]
...
# compile and install
# You can optionally include specific modules like vllm, sglang, or bitblas by adding them in brackets. Example: pip install -vvv --no-build-isolation .[vllm,sglang,bitblas,lm_eval]
...
# Include modules as needed: uv pip install -vvv --no-build-isolation .[vllm,sglang,bitblas,lm_eval]
uv pip install -vvv --no-build-isolation .
```

### Script installation  
```bash
# You can pass modules as arguments, e.g., --vllm --sglang --bitblas --lm_eval. Example: bash install.sh --vllm --sglang --bitblas --lm_eval
bash install.sh
```
