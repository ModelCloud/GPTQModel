...
- Commit: `64a9cb6f4ba33f7b83a317651e44b4810cf392ea`; benchmark SHA256: `ae13dac8f763d972716bba127790a3bffea2c83f7d2e91d7479728527011b6ca`
...
- M values: `[1, 16]`; warmup: `20`; measured launches: `60`
...
|---|---|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| mlp_gate_up | gate_proj/up_proj | 1 | 2048 | 8192 | qvq_lr | 3.5 | P32 | 0.0360 | 0.0364 | 0.931 | 205.53 | 0.287x | 0.516x | 5.91e-05 |
| mlp_gate_up | gate_proj/up_proj | 16 | 2048 | 8192 | qvq_lr | 3.5 | P32 | 0.0375 | 0.0379 | 14.315 | 197.46 | 0.300x | 0.497x | 6.1e-05 |
| mlp_gate_up | gate_proj/up_proj | 1 | 2048 | 8192 | gptq_marlin | 4 | 128 | 0.0103 | 0.0106 | 3.246 | 836.95 | 1.000x | 1.799x | 0.000218 |
| mlp_gate_up | gate_proj/up_proj | 16 | 2048 | 8192 | gptq_marlin | 4 | 128 | 0.0113 | 0.0116 | 47.663 | 768.00 | 1.000x | 1.655x | 0.000319 |
| mlp_gate_up | gate_proj/up_proj | 1 | 2048 | 8192 | gptq_machete | 4 | 128 | 0.0186 | 0.0199 | 1.805 | 465.73 | 0.556x | 1.000x | 0.000218 |
| mlp_gate_up | gate_proj/up_proj | 16 | 2048 | 8192 | gptq_machete | 4 | 128 | 0.0186 | 0.0197 | 28.802 | 464.54 | 0.604x | 1.000x | 0.000281 |
