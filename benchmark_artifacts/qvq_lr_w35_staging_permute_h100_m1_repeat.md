...
- M values: `[1]`; warmup: `20`; measured launches: `60`
...
|---|---|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| mlp_gate_up | gate_proj/up_proj | 1 | 2048 | 8192 | qvq_lr | 3.5 | P32 | 0.0372 | 0.0376 | 0.902 | 199.16 | 0.265x | 0.482x | 5.91e-05 |
| mlp_gate_up | gate_proj/up_proj | 1 | 2048 | 8192 | gptq_marlin | 4 | 128 | 0.0099 | 0.0102 | 3.399 | 876.29 | 1.000x | 1.815x | 0.000218 |
| mlp_gate_up | gate_proj/up_proj | 1 | 2048 | 8192 | gptq_machete | 4 | 128 | 0.0179 | 0.0188 | 1.872 | 483.20 | 0.551x | 1.000x | 0.000218 |
