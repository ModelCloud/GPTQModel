...
results_dir="${1:-${repo_root}/scripts/quantum_quantization/results/llama32_adjacent_ab/${run_timestamp}}"
checkpoint_root="$(mktemp -d /tmp/gptqmodel_llama32_adjacent_ab.XXXXXX)"
