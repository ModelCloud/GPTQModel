...
from deps_utils import build_specific_deps_env_suffix, collect_pkgs, is_model_test, resolve_test_path
...
def build_env_name(test_name: str, deps: dict) -> str:
    ...
    is_model = is_model_test(test_name)
    prefix = "gptqmodel_unit_tests_models" if is_model else "gptqmodel_unit_tests"
