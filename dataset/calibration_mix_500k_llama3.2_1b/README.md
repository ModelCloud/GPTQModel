...
Using the full mix as the disjoint YAQA stream for Llama 3.2 1B W2 V2B2-P32 changed the checkpoint and improved the locked 300-row diagnostics from 0.324339 to 0.264975 final KL and from 71.4331% to 76.0206% divergence-32 token top-1 agreement. The ordinary lifecycle stream, optimized YAQA stream, and evaluation slice had zero canonical content-hash intersections.
